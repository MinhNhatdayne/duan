...
//    private Button btnLogin;
//    private TextView tvForgotPassword, tvRegisterLink;
//    private CheckBox cbRemember; // Khai báo CheckBox
//
//    @Override
//    protected void onCreate(Bundle savedInstanceState) {
//        super.onCreate(savedInstanceState);
//
//        // 1. Kiểm tra trạng thái đăng nhập trước khi nạp giao diện
//        // Nếu đã đăng nhập rồi (IS_LOGGED_IN = true) thì vào thẳng Dashboard
//        checkLoginStatus();
//
//        setContentView(R.layout.activity_login);
//
...
//        initViews();
//
//        // 3. Kiểm tra xem có thông tin "Ghi nhớ" (Remember Me) không để điền sẵn
//        checkRememberedUser();
//
//        // 4. Xử lý sự kiện Đăng nhập
...
//        tvForgotPassword = findViewById(R.id.tv_forgot_password);
//        tvRegisterLink = findViewById(R.id.tv_register_link);
//        cbRemember = findViewById(R.id.cb_remember); // Ánh xạ checkbox
//    }
//
//    // Hàm kiểm tra nếu người dùng chưa đăng xuất thì vào thẳng ứng dụng
//    private void checkLoginStatus() {
//        SharedPreferences preferences = getSharedPreferences("UserPrefs", MODE_PRIVATE);
//        boolean isLoggedIn = preferences.getBoolean("IS_LOGGED_IN", false);
//        String savedRole = preferences.getString("USER_ROLE", "PATIENT");
//
//        if (isLoggedIn) {
//            navigateUser(savedRole);
//        }
//    }
//
//    // Hàm điền sẵn thông tin nếu người dùng từng tích vào "Ghi nhớ đăng nhập"
...
//                        Toast.makeText(LoginActivity.this, "Đăng nhập thành công!", Toast.LENGTH_SHORT).show();
//
//                        // Lấy Role để lưu và điều hướng
//                        String role = loginResponse.getRole();
//                        if (role == null) role = "PATIENT";
//
//                        // 1. Lưu session và xử lý Ghi nhớ mật khẩu
//                        saveUserSession(loginResponse.getData(), role, password);
//
//                        // 2. Điều hướng
//                        navigateUser(role);
//
...
//    }
//
//    // Lưu thông tin người dùng và xử lý Checkbox Ghi nhớ
//    private void saveUserSession(LoginResponse.BenhNhan user, String role, String rawPassword) {
//        SharedPreferences preferences = getSharedPreferences("UserPrefs", MODE_PRIVATE);
//        SharedPreferences.Editor editor = preferences.edit();
//
...
//        }
//        editor.putString("USER_NAME", user.getHo_ten());
//        editor.putString("USER_ROLE", role); // Quan trọng: Lưu Role để lần sau tự vào đúng màn hình
...
//            editor.putString("SAVED_PASS", rawPassword);
//        } else {
...
//    private void navigateUser(String role) {
//        Intent intent = null;
//
//        switch (role) {
//            case "MANAGER":
